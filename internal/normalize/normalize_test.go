...
func TestNormalize_AllSixSourcesGolden(t *testing.T) {
	...
	sources := []struct {
		...
		},
		{
			...
			fixturePath:  "testdata/sources/cloud-audit/valid_audit.json",
			expectedPath: "testdata/sources/cloud-audit/expected.json",
			packName:     "cloud-audit",
			transport:    "http_post",
			sourceIP:     "198.51.100.12",
		},
		{
			name:         "Container Runtime JSON",
			fixturePath:  "testdata/sources/container-runtime/valid_container.json",
			expectedPath: "testdata/sources/container-runtime/expected.json",
			packName:     "container-runtime",
			transport:    "http_post",
			sourceIP:     "10.244.0.15",
		},
		{
			name:         "IAM Auth LEEF",
			fixturePath:  "testdata/sources/iam-auth-leef/valid_auth.leef",
			expectedPath: "testdata/sources/iam-auth-leef/expected.json",
			packName:     "iam-auth-leef",
			transport:    "syslog_tls",
			sourceIP:     "192.168.1.10",
		},
		{
			name:         "IoT Gateway XML",
			fixturePath:  "testdata/sources/iot-gateway-xml/valid_iot.xml",
			expectedPath: "testdata/sources/iot-gateway-xml/expected.json",
			packName:     "iot-gateway-xml",
			transport:    "http_post",
			sourceIP:     "192.168.10.88",
		},
		{
			name:         "Appliance Proprietary Text",
			fixturePath:  "testdata/sources/appliance-proprietary-text/valid_appliance.log",
			expectedPath: "testdata/sources/appliance-proprietary-text/expected.json",
			packName:     "appliance-proprietary-text",
			transport:    "file_spool",
			sourceIP:     "172.16.50.4",
		},
		{
			name:         "Perimeter XML Alert",
			fixturePath:  "testdata/sources/network-perimeter-xml/valid_alert.xml",
			expectedPath: "testdata/sources/network-perimeter-xml/expected.json",
			packName:     "network-perimeter-xml",
			transport:    "http_post",
			sourceIP:     "203.0.113.89",
		},
		{
			name:         "Perimeter LEEF Session",
			fixturePath:  "testdata/sources/network-perimeter-leef/valid_session.leef",
			expectedPath: "testdata/sources/network-perimeter-leef/expected.json",
			packName:     "network-perimeter-leef",
