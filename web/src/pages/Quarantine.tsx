...
import { AlertTriangle, Play, RefreshCw, CheckCircle2, ChevronLeft, ChevronRight, FileCode } from 'lucide-react';
          ...
          <table className="w-full text-left text-xs font-mono">
            <thead>
              <tr className="bg-[#0d1117] text-[#8b949e] border-b border-[#21262d]">
                <th className="py-2.5 px-3 font-medium">Quarantine ID</th>
                <th className="py-2.5 px-3 font-medium">Stage</th>
                <th className="py-2.5 px-3 font-medium">Reason</th>
                <th className="py-2.5 px-3 font-medium">Raw Preview</th>
                <th className="py-2.5 px-3 font-medium">Quarantined At</th>
              ...
              {entries.length === 0 ? (
                ...
                entries.map((item) => (
                  <tr key={item.quarantine_id} className="hover:bg-[#21262d]/50 transition-colors">
                    <td className="py-2 px-3 font-semibold text-rose-400">
                      {item.quarantine_id}
                    </td>
                    ...
                    <td className="py-2 px-3 max-w-xs truncate text-[#8b949e]">
                      {item.raw_preview}
                    </td>
        ...
        >
          <div className="bg-[#161b22] border border-[#30363d] rounded-md max-w-2xl w-full p-5 space-y-4">
            ...
            <div>
              ...
              <pre className="bg-[#0d1117] border border-[#21262d] p-3 rounded text-xs font-mono text-[#c9d1d9] overflow-auto max-h-48 whitespace-pre-wrap">
            ...
            <div className="flex justify-end space-x-2">
              <button
                onClick={() => setSelectedPreview(null)}
                className="px-3 py-1.5 bg-[#21262d] text-xs font-mono rounded text-[#c9d1d9]"
              >
                Cancel
              </button>
              <button
                ...
                className="px-3 py-1.5 bg-[#238636] hover:bg-[#2ea043] text-white text-xs font-mono font-medium rounded flex items-center"
              >
